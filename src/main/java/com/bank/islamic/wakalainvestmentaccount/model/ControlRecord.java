package com.bank.islamic.wakalainvestmentaccount.model;
...
/**
 * The BIAN control record for this service domain: "Wakala Investment Account Fulfillment Arrangement".
 *
 ...
 * to its asset type (Wakala Investment Account). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Wakala Investment Account Fulfillment Arrangement";
